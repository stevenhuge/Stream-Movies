...
public class fetchEpisode extends AsyncTask<String,Void,String> {
    private ArrayList<movieData> values;
    private com.example.movieapi.adapter.movieAdapter movieAdapter;
    private RecyclerView recyclerView;
    private Context context;

    public fetchEpisode(ArrayList<movieData> values, com.example.movieapi.adapter.movieAdapter movieAdapter,
    ...
    protected String doInBackground(String... strings) {
        ...
        String BASE_URL="https://omdbapi.com/?apikey=5e20535a&type=episode&";
