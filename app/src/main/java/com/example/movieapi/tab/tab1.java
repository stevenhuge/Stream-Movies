...
import com.example.movieapi.fetch.fetchEpisode;
import com.example.movieapi.fetch.fetchMovie;
...
public class tab1 extends Fragment {
    ...
    private void searchBook(){
        ...
        if (networkInfo!=null && networkInfo.isConnected()){
            new fetchEpisode(values, movieAdapter, recyclerView, this.getContext())
                    .execute(queryString);
        }else {
